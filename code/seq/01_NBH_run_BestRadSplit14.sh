#!/bin/bash -l
#SBATCH -J NBH_split
#SBATCH -o code/seq/slurm_out/NBH_split_out_%A_%a.txt
#SBATCH -e code/seq/slurm_out/NBH_split_err_%A_%a.txt
#SBATCH -p med
#SBATCH --mem=30g
#SBATCH -t 48:00:00
