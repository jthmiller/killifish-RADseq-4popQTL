...
perm_cross <- subset(cross, chr = c(1,3:4,6:10,12:17,19:24))
...
fit_hk_bin_perm <- fitqtl(cross, pheno.col=4, method="hk", model="bin", qtl = hk.qtl.3_perms,
